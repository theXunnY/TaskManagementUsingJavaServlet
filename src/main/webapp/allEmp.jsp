        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="btn btn-primary" href="update.jsp?id=<%=employee.getId() %>" >UPDATE</a></td>
                    <td><a class="btn btn-danger" href="del?id=<%=employee.getId()%>" onclick="return confirm('Are you sure you want to delete this employee?')" >DELETE</a></td>
                </tr>
                <% } %>
            </tbody>
        </table>
